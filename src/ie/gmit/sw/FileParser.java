...
public class FileParser {
	...
	{	
	       ...
	       // Store each line in a string so it can be appended to our fileConents variable
	       String perLine;
	       
	       // While there are still lines to read by the buffereReader
	       while ((perLine = bufferedReader.readLine()) != null) 
	       {
	    	   // Append our fileConents variable with the contents of perLine(each line of the file)
